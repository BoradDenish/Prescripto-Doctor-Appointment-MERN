...
//     // // Fetch prescriptions for the given appointmentId
//     // useEffect(() => {
//     //     const fetchPrescriptions = async () => {
//     //         try {
//     //             const response = await axios.get(`${backendUrl}/api/prescriptions/${appointmentId}`, {
...
//             {/* Prescription Form */}
//             <form onSubmit={handleAddPrescription} className="add-prescription-form">
...
//                             <p><strong>Prescribed by:</strong> {prescription.doctor_id.name} ({prescription.doctor_id.specialty})</p>
//                             <p><strong>Prescribed on:</strong> {new Date(prescription.date_prescribed).toLocaleDateString()}</p>
//                         </li>
//                     ))
//                 ) : (
...
//           ))
//         ) : (
//           <p>No prescriptions available for this user.</p>
//         )}
//       </ul>
//     </div>
//   );
...
//   // Handle submitting a new prescription
//   const handleAddPrescription = async (e) => {
//     e.preventDefault();
...
//     //     const fetchPrescriptions = async () => {
//     //         try {
//     //             const response = await axios.get(`${backendUrl}/api/prescriptions`, {
//     //                 headers: {
//     //                     Authorization: `Bearer ${dToken}`
//     //                 }
//     //             });
...
//     //         fetchPrescriptions(); // Call the fetch function when the component mounts
//     //     }
//     // }, [dToken, backendUrl]); // Re-run this effect if the dToken changes
