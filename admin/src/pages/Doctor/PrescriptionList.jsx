...
const MyPrescriptions = () => {
    ...
    const getUserPrescriptions = async (searchQuery = '') => {
        console.log("hello--->")
        const { data } = await axios.get(backendUrl + '/api/doctor/list-prescription', { headers: { dToken }, params: { search: searchQuery }, });
    ...
    const deleteUserPrescriptions = async (prescriptionId) => {
        try {
            ...
            const { data } = await axios.post(`${backendUrl}/api/doctor/delete-prescription`, {
...
//                                 <button
//                                 className="mt-2 text-red-600 hover:text-red-800 text-sm"
//                                 onClick={() => deleteUserPrescriptions(item._id)} // Delete the prescription
//                             >
//                                 Delete
//                             </button>
//                             </div>
